...
Convolution, in practice, takes a 4-D \\( w_{pjkl} \\) tensor (as in multidimensional array) and slides it across another 4-D tensor \\( x_{ijkl} \\) to produce a set of filtered images. In \\( w_{pjkl} \\), \\( p
